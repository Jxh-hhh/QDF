...
def generate_subcircuit_entries(compute_graph):
    ...
    instance_init_meas_ids = {subcircuit_idx: {subcircuit_instances[subcircuit_idx][i]: i for i in
                                               range(len(subcircuit_instances[subcircuit_idx]))} for
                              subcircuit_idx in subcircuit_instances}
    entry_init_meas_ids = {subcircuit_idx: {subcircuit_entries[subcircuit_idx][i]: i for i in
                                            range(len(subcircuit_entries[subcircuit_idx]))} for
                           subcircuit_idx in subcircuit_entries}
    return subcircuit_entries, subcircuit_instances, instance_init_meas_ids, entry_init_meas_ids
